    ...
    <>
      <div className="flex items-center gap-1.5 justify-end w-full">
        ...
        <button
          ...
          className={`inline-flex items-center justify-center w-7 h-7 rounded-lg transition-colors border shadow-sm ${notes ? 'bg-violet-50 border-violet-200 text-violet-600 dark:bg-violet-900/30 dark:border-violet-800 dark:text-violet-400' : 'bg-white dark:bg-zinc-800 border-gray-200 dark:border-zinc-700 text-gray-400 hover:bg-gray-100 dark:hover:bg-zinc-700 dark:text-zinc-500 hover:text-gray-600 dark:hover:text-gray-300'}`}
        >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
          <div className="bg-white dark:bg-zinc-900 w-full max-w-sm rounded-2xl shadow-xl border border-gray-100 dark:border-zinc-800 p-5 flex flex-col gap-4 animate-in fade-in zoom-in-95 duration-200">
            ...
            <textarea
              ...
              className="w-full min-h-[120px] border border-gray-200 dark:border-zinc-800 bg-gray-50 dark:bg-zinc-950/50 rounded-xl p-3 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500 transition-shadow resize-none"
            />
            <div className="flex items-center justify-end gap-2 mt-1">
              ...
              <button
                ...
                disabled={isPending}
                className="px-4 py-2 rounded-xl text-sm font-bold bg-violet-600 text-white hover:bg-violet-700 transition-colors shadow-sm disabled:opacity-50"
              >
