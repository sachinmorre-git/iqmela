            ...
            <div className="flex flex-col gap-3">
              <label className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="w-full border border-gray-200 dark:border-zinc-800 bg-gray-50 dark:bg-zinc-950/50 rounded-lg p-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 transition-shadow"
                />
              </label>
