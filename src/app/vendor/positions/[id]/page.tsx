  ...
  if (!invite) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
        ...
        <Link href="/vendor/dashboard" className="text-indigo-600 font-semibold hover:underline">
          Return to Dashboard
        </Link>
      </div>
    );
  ...
  return (
    <div className="flex-1 space-y-8 max-w-4xl mx-auto p-4 md:p-8 w-full">
      <Link
        ...
        className="text-sm font-medium text-gray-500 hover:text-indigo-600 dark:text-zinc-400 dark:hover:text-indigo-400 flex items-center mb-6 transition-colors w-fit"
      >
      ...
      <div className="bg-white dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 rounded-3xl p-6 lg:p-10 shadow-sm">
        <div className="flex items-start justify-between border-b border-gray-100 dark:border-zinc-800 pb-8 mb-8">
          <div>
            <div className="inline-flex items-center px-3 py-1 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 rounded-full text-xs font-bold uppercase tracking-widest mb-4">
              Secure Upload Zone
            </div>
