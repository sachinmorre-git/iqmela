...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-full text-base font-semibold transition-all duration-300 ease-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rose-600 dark:focus:ring-offset-zinc-950 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-rose-600 text-white shadow-lg shadow-rose-600/20 hover:bg-rose-700 hover:shadow-xl hover:shadow-rose-600/30 hover:-translate-y-0.5",
